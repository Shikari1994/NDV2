      ...
      <div className="container about-layout">
        <div className="about-intro">
          ...
          <p className="about-text reveal">
            Закрываем весь путь от забойного датчика до отчёта заказчику: проектируем
            и выпускаем системы MWD/LWD, наземные станции декодирования и диспетчерский
            программный комплекс. Нашими решениями оснащены объекты ведущих добывающих
